...
export type Launch_ListQueryVariables = Exact<{ [key: string]: never }>;

export type Launch_ListQuery = { __typename?: "Query" } & {
  launches?: Maybe<
    Array<
      Maybe<
...
export const Launch_ListDocument = gql`
  query Launch_List {
    launches {
      flight_number
      mission_name
...
/**
 * __useLaunch_ListQuery__
 *
 * To run a query within a React component, call `useLaunch_ListQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunch_ListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunch_ListQuery({
 *   variables: {
 *   },
 * });
 */
export function useLaunch_ListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    Launch_ListQuery,
    Launch_ListQueryVariables
  >
) {
  return Apollo.useQuery<Launch_ListQuery, Launch_ListQueryVariables>(
    Launch_ListDocument,
    baseOptions
  );
}
export function useLaunch_ListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Launch_ListQuery,
    Launch_ListQueryVariables
  >
) {
  return Apollo.useLazyQuery<Launch_ListQuery, Launch_ListQueryVariables>(
    Launch_ListDocument,
    baseOptions
  );
}
export type Launch_ListQueryHookResult = ReturnType<typeof useLaunch_ListQuery>;
export type Launch_ListLazyQueryHookResult = ReturnType<
  typeof useLaunch_ListLazyQuery
>;
export type Launch_ListQueryResult = Apollo.QueryResult<
  Launch_ListQuery,
  Launch_ListQueryVariables
>;
